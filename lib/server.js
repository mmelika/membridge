...
function projectDetail(projectPath) {
  ...
  return {
    ...
    teamEntries: (proj.teamEntries || []).slice(-50).map(e => ({
      ...e,
...
module.exports = { startServer, statusPayload, projectsPayload, projectDetail, toggleProject, addProject, deleteProject, removeBlockFromProject, copyPayload, settingsPayload, saveSettings, teamPayload, teamProjectsPayload, runTeamSync, scanPayload };
