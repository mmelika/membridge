...
body.signed-out #view-settings, body.signed-out #view-team { display: none !important; }
...
@media (max-width: 590px) {
  ...
  #view-home .inner, #view-project .inner, #view-team .inner, #view-settings .inner { padding: 32px 18px 60px; }
...
// delegation at the Settings container (mirrors the teamRoot/authRoot wiring).
