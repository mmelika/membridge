...
var currentTab = function () {
  ...
  if (location.hash === '#team' || location.hash.indexOf('#team-member=') === 0 ||
      location.hash.indexOf('#team-project=') === 0) return 'team';
...
window.addEventListener('keydown', function (e) {
  ...
  if (hadModal) return;
  if (currentTab() === 'project' || currentTab() === 'settings') location.hash = '#overview';
  // A team member/project page backs out to the team hub, not Overview.
  else if (currentTab() === 'team' && location.hash !== '#team') location.hash = '#team';
});
